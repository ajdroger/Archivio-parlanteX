...
health:
	...
	@echo ""
	@echo "PHP Gateway:"
	@curl -s http://localhost:9080/health || echo "❌ PHP Gateway not responding"
	@echo ""
	@echo "Rust Engine:"
	...
	@echo ""
	@echo "Qdrant:"
	@curl -s http://localhost:6335/healthz || curl -s http://localhost:6335 || echo "❌ Qdrant not responding"
	@echo ""
	@echo "Ollama:"
